...
export default function ImpactSection() {
  return (
    <>
      <div className="grid sm:grid-cols-2 xl:grid-cols-4 pt-11  gap-x-8 gap-y-16">
        <ImpactsCard
          number="8"
          title={
            <>
              Computer <br></br>Technology
            </>
          }
          description={
            <span>
        ...
        <ImpactsCard
          ...
          description={
            <>
              Enrolled over 14,500 blind and <br />
              visually impaired students and <br />
              teachers
            </>
          }
        />
        ...
        <ImpactsCard
          ...
          description={
            <>
              Provided more than 43,000 <br /> hours of assistive <br />
              technology computer skills <br /> training
            </>
          }
        />
      </div>
      <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-x-5 gap-y-3 lg:my-8 sm:my-3 md:my-3  lgjustify-center">
        <ImpactsCard
          ...
          description={
            <>
              currently in partnership with <br />
              schools for the blind in Siaya,
              <br />
              Thika, Meru and Mombasa <br />
              counties
            </>
          }
        />
        <ImpactsCard
          ...
          description={
            <>
              (Inclusive Africa Conference <br />
              and Advocacy) <br />
              Facilitated first-ever ICT <br />
        ...
        />
        <ImpactsCard
          title={<div className="py-5">Inclusive Libraries</div>}
          description={
            <>
