    ...
    return (
        <>
            <Layout>
                ...
                <h2 className="text-5xl font-semibold px-12 mx-12">Relevance</h2>
                <RelevanceCard
                    impactname={
                ...
                <h4 className="text-5xl font-semibold mx-5 px-5 py-8">About Previous Conferences</h4>
                ...
                <div className="mt-10 py-10 text-center">
                    ...
                    <div className="grid grid-cols-3 gap-1 mx-12 px-12">
                        <div>
